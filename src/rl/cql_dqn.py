...
class DQNCQL:
    ...
    def load_state_dict(self, state_dict: Dict[str, Any]):
        ...
        self.target_q_1.load_state_dict(state_dict=state_dict["target_q_1"])
        self.target_q_2.load_state_dict(state_dict=state_dict["target_q_2"])

        self.q_1_optimizer.load_state_dict(
            state_dict=state_dict["q_1_optimizer"]
        )
        self.q_2_optimizer.load_state_dict(
            state_dict=state_dict["q_2_optimizer"]
        )
